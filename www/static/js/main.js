...
define(function(require, exports) {
	var server_version = '1.0';//最新版本
	var local_version  = G.version;
	var readmore_href  = 'http://www.431103.com/download.html';
	var current_version_file = 'http://static.431103.com/download/update/2.0-'+server_version+'.zip';
	var status_href = 'http://431103.com/tools/state/index.php';
	...
	var _unzip = function(file,unzip_to,callback){
		$.ajax({
			url:'/explorer/unzip&path_to='+urlEncode(unzip_to)
				+'&path='+urlEncode(file),
			success:function(data){
				if (typeof (callback) == 'function') callback(data);
			}
