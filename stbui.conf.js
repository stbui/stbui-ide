...
stbui
    ...
    .match("{framework/dialog/*.js,framework/event/*.js,framework/touch/*.js,framework/ajax/*.js,framework/form/*.js}", {
        packTo: "/pkg/framework.js",
    })
    .match(/^\/page\/(.*)\/(.*)\.(js)$/i, {
...
stbui
    ...
    // .match("{framework/reset/*.css,framework/text/*.css,framework/grid/*.css,framework/panel/*.css,framework/btn,btn-group/*.css,framework/badge/*.css,framework/label/*.css,framework/tag/*.css,framework/searchbar/*.css,framework/list/*.css,framework/table/*.css,framework/notice/*.css,framework/tips/*.css,framework/tooltips/*.css,framework/newstips/*.css,framework/poptips/*.css,framework/actionsheet/*.css,framework/dialog/*.css,framework/tab/*.css}", {
    //     packTo: "/pkg/framework.css",
    // })
    .match(/^\/page\/(.*)\/(.*)\.(less)$/i, {
